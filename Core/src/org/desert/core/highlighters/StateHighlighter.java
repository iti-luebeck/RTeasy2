...
public class StateHighlighter {

    private final OffsetsBag bag;

    public StateHighlighter(Document doc) {
        bag = new OffsetsBag(doc);
        Simulator.setStepHighlighter(this);
    }
     ...
     */
    public void updateStepMark(int startOffset, int endOffset, Color color) {
        bag.clear();
     ...
     */
    public void removeAllStepMarks() {
        bag.clear();
    }
